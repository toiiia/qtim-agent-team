...
color: orange
memory: "project"
tools: [Read, Write, WebSearch, Skill, TaskCreate, TaskUpdate, SendMessage]
---
...
оркестрацией стадий занимается team-lead через `/qtim:feature`, ты исполняешь свой режим.
...
- какие указатели добавить в `memory/`.
